...
Introduced in version 1.0, you can now make backups of your Deemon Redux installation including your _config.json_, 
_deemon-redux.db_ and (optionally) the _logs_ directory.
...
Backed up to /home/user/.config/deemon-redux/backups/20210603-233151.tar
```
